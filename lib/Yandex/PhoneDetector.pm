...
# Constants
use constant LWP_USER_AGENT=>'Mozilla/5.0 (compatible; Yandex::PhoneDetector/1.0; +http://search.span.org/)';
...
Yandex::PhoneDetector - Detector mobile phone

=head1 SYNOPSIS

	#!/usr/bin/perl
	use strict;
	use Yandex::PhoneDetector;
	use Data::Dumper;

	my $phone_detector = Yandex::PhoneDetector->new();
